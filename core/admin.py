...
from core.models import Post, Friend, FriendRequest, Notification, Comment, Gallery, ReplyComment, Group, GroupPost, Page, PagePost, ChatMessage, GroupChat, GroupChatMessage, Story, DevelopersCommunity
...
class GroupProfileTabAdmin(admin.TabularInline):
    model = Group
...
class GroupPostAdmin(admin.ModelAdmin):
    ...
    list_editable = ['user', 'title', 'visibility','group']
    list_display = ['thumbnail', 'user', 'title', 'visibility','group']
    prepopulated_fields = {"slug": ("title", )}



class GroupAdmin(admin.ModelAdmin):
    #inlines = [GroupProfileTabAdmin]
    #inlines = [GroupProfileTabAdmin]
...
class DevelopersAdmin(admin.ModelAdmin):
    list_editable = ['user', 'title', 'visibility']
    list_display = ['thumbnail', 'user', 'title','video', 'visibility']
...
admin.site.register(DevelopersCommunity, DevelopersAdmin)
